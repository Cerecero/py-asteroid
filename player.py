...
class Player(CircleShape):
    # Class attribute
    containers = ()  # Placeholdes for containers, will be set externally, its a tuple for groups

    def __init__(self, x, y):
        super().__init__(x, y, PLAYER_RADIUS)
        self.rotation = 0
        for group in self.containers:  # Adds this instance to each group in containers
            group.add(self)
